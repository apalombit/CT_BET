...
import pathlib
import os
os.chdir("/Users/ale/Desktop/highresnet-master/")
from highresnet.inference import infer
input_path = "/Users/ale/Desktop/T1.nii"
output_path  = None
batch_size  = 1
window_cropping  = 2
volume_padding  = 10
...
infer(input_path,output_path,batch_size,window_cropping,volume_padding,window_size,cuda_device,use_niftynet_hist_std=hist_niftynet)
